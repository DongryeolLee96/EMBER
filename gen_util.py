...
def greedy_decoding_mistral (inputs_with_prompts, engine, max_tokens):
    ...
    chatbot=transformers.pipeline("text-generation", model=engine, max_new_tokens=max_tokens)
...
class ParallelGPT():
    ...
    def generate(self, text, max_new_tokens=1024, temperature=0, num_return_sequences=1, **kwargs):
